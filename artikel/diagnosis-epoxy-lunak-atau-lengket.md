---
article_id: KEP-12-A04
title: "Epoxy Tetap Lunak atau Lengket: Investigasi Mixing, Suhu, dan Cure"
slug: "diagnosis-epoxy-lunak-atau-lengket"
description: "Preserve batch/environment evidence and identify safe investigation paths"
status: outline
...
final_route: "/artikel/diagnosis-epoxy-lunak-atau-lengket.html"
...
# Epoxy Tetap Lunak atau Lengket: Investigasi Mixing, Suhu, dan Cure

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Epoxy Tetap Lunak atau Lengket: Investigasi Mixing, Suhu, dan Cure”
- **Reader and situation:** Team facing soft surface
- **Reader outcome:** Preserve batch/environment evidence and identify safe investigation paths
...
- **Scope boundary:** Excludes chemical handling without KEP-07 controls and repair selection (KEP-13-A03)
- **Final public route:** `/artikel/diagnosis-epoxy-lunak-atau-lengket.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Epoxy Tetap Lunak atau Lengket: Investigasi Mixing, Suhu, dan Cure**.
...
- `KEP-12-A03` → `/artikel/atlas-cacat-permukaan-epoxy.html` — Pinholes, Bubble, Fisheye, Crater, dan Orange Peel: Atlas Cacat Permukaan
...
- `KEP-12-A06` → `/artikel/diagnosis-noda-aus-licin-dan-serangan-kimia.html` — Noda, Aus, Licin, Perubahan Warna, dan Serangan Kimia: Memisahkan Penyebab
...
- **Tie back to this article:** Keep the explanation specific to “Epoxy Tetap Lunak atau Lengket: Investigasi Mixing, Suhu, dan Cure”.
