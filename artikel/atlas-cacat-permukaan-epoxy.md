---
article_id: KEP-12-A03
title: "Pinholes, Bubble, Fisheye, Crater, dan Orange Peel: Atlas Cacat Permukaan"
slug: "atlas-cacat-permukaan-epoxy"
description: "Separate appearance, timing, likely mechanisms, evidence, and disposition"
status: outline
publication_date: "2026-03-14"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KEP-12
primary_intent: "Identify visual defects"
reader_community: "Kontraktorepoxy.co.id"
reader_address: "Teman Kontraktorepoxy.co.id"
final_route: "/artikel/atlas-cacat-permukaan-epoxy.html"
...
# Pinholes, Bubble, Fisheye, Crater, dan Orange Peel: Atlas Cacat Permukaan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pinholes, Bubble, Fisheye, Crater, dan Orange Peel: Atlas Cacat Permukaan”
- **Reader and situation:** Inspector at punch list
- **Reader outcome:** Separate appearance, timing, likely mechanisms, evidence, and disposition
- **Primary intent:** Identify visual defects
...
- **Scope boundary:** Excludes acceptance authority (KEP-08-A05) and blanket cosmetic repair
- **Final public route:** `/artikel/atlas-cacat-permukaan-epoxy.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pinholes, Bubble, Fisheye, Crater, dan Orange Peel: Atlas Cacat Permukaan**.
...
- `KEP-12-A01` → `/artikel/diagnosis-epoxy-menggelembung.html` — Epoxy Menggelembung: Pohon Penyebab Moisture, Udara, Osmosis, dan Aplikasi
- `KEP-12-A02` → `/artikel/diagnosis-epoxy-mengelupas-delaminasi.html` — Epoxy Mengelupas atau Delaminasi: Menentukan Bidang Kegagalan
- `KEP-12-A04` → `/artikel/diagnosis-epoxy-lunak-atau-lengket.html` — Epoxy Tetap Lunak atau Lengket: Investigasi Mixing, Suhu, dan Cure
- `KEP-12-A05` → `/artikel/diagnosis-retak-menembus-coating.html` — Retak Menembus Coating dan Joint Terbuka: Membaca Pola Pergerakan
...
- **Tie back to this article:** Keep the explanation specific to “Pinholes, Bubble, Fisheye, Crater, dan Orange Peel: Atlas Cacat Permukaan”.
