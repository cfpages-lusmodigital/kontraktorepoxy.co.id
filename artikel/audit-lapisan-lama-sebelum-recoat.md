---
article_id: KEP-02-A06
title: "Membaca Cat Lama: Adhesi, Lapisan Tersembunyi, dan Uji Area Percobaan"
slug: "audit-lapisan-lama-sebelum-recoat"
description: "Plan identification, adhesion screening, trial areas, and removal decision evidence"
status: outline
publication_date: "2025-07-29"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KEP-02
primary_intent: "Decide whether old coating can remain"
reader_community: "Kontraktorepoxy.co.id"
reader_address: "Sobat Kontraktorepoxy.co.id"
final_route: "/artikel/audit-lapisan-lama-sebelum-recoat.html"
...
# Membaca Cat Lama: Adhesi, Lapisan Tersembunyi, dan Uji Area Percobaan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Membaca Cat Lama: Adhesi, Lapisan Tersembunyi, dan Uji Area Percobaan”
- **Reader and situation:** Retrofit team facing unknown coating
- **Reader outcome:** Plan identification, adhesion screening, trial areas, and removal decision evidence
- **Primary intent:** Decide whether old coating can remain
...
- **Scope boundary:** Excludes recoat application (KEP-13-A04) and final acceptance testing (KEP-08-A03)
- **Final public route:** `/artikel/audit-lapisan-lama-sebelum-recoat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Membaca Cat Lama: Adhesi, Lapisan Tersembunyi, dan Uji Area Percobaan**.
...
- `/cat-epoxy-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/cat-epoxy-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/cat-epoxy-tuban.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/cat-epoxy-tuban` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/cat-epoxy-ternate.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/cat-epoxy-ternate` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `KEP-02-A04` → `/artikel/audit-kontaminasi-lantai-sebelum-epoxy.html` — Audit Kontaminasi Minyak, Lemak, Silikon, dan Bahan Kimia pada Lantai
...
- **Tie back to this article:** Keep the explanation specific to “Membaca Cat Lama: Adhesi, Lapisan Tersembunyi, dan Uji Area Percobaan”.
